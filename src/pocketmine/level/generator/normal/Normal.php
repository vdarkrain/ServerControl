...
class Normal extends Generator{
	...
	public function init(ChunkManager $level, Random $random) : void{
		...
		$ores = new Ore();
		$ores->setOreTypes([
			new OreType(BlockFactory::get(57), 20, 16, 0, 128),
			new OreType(BlockFactory::get(57), 20, 8, 0, 64),
			new OreType(BlockFactory::get(57), 8, 7, 0, 16),
			new OreType(BlockFactory::get(57), 1, 6, 0, 32),
			new OreType(BlockFactory::get(57), 2, 8, 0, 32),
			new OreType(BlockFactory::get(57), 1, 7, 0, 16),
			new OreType(BlockFactory::get(57), 20, 32, 0, 128),
			new OreType(BlockFactory::get(57), 10, 16, 0, 128)
		]);
